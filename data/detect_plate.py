...
def crop_result(img, boxes, confidences, class_ids, class_names, min_confidence=0.5):
...
def plate2detect(img, min_confidence = 0.5):
    boxes, confidences, class_ids = get_predicts(img, model, predict_layer_names, min_confidence = 0.5)
    crop_result(img, boxes, confidences, class_ids, class_names, min_confidence = min_confidence)
